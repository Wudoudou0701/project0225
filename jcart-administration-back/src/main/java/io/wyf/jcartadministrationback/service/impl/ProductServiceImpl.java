...
import io.wyf.jcartadministrationback.dao.ProductDetailMapper;
import io.wyf.jcartadministrationback.dao.ProductMapper;
...
import io.wyf.jcartadministrationback.po.Product;
import io.wyf.jcartadministrationback.po.ProductDetail;
import io.wyf.jcartadministrationback.service.ProductService;
...
*/
    ...
    @Override
    @Transactional
    public Integer creat(ProductCreateInDTO productCreateInDTO) {
        Product product = new Product();
        product.setProductCode(productCreateInDTO.getProductCode());
        product.setProductName(productCreateInDTO.getProductName());
        product.setPrice(productCreateInDTO.getPrice());
